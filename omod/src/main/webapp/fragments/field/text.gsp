...
<p <% if (config.left) { %> class="left" <% } %> >
    ...
    <input class="form-control form-control-sm form-control-lg form-control-md" type="text" id="${ config.id }-field" name="${ config.formFieldName }" value="${ config.initialValue ?: '' }"
